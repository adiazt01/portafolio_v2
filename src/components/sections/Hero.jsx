    ...
    <>
      <section className="grid h-min mt-12 md:mt-14">
        ...
        <div className="row-span-1 h-min grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0">
          <div className="col-span-1 px-5 tracking-tight mt-4 md:mt-0 md:rounded-bl-2xl md:rounded-none flex flex-col md:justify-start md:border-r-0 border-2 rounded-xl border-purple-950 pb-12 py-8 bg-gradient-to-b from-transparent from-60% via-zinc-950 to-zinc-900 shadow-md shadow-purple-950">
            ...
            <p className="text-zinc-400 mt-1 md:text-md lg:text-xl">
              ...
              apps web{" "}
              <BiWorld className="inline-block align-text-bottom mb-0.5" /> .
              Currently, I am focused on exploring different back end{" "}
              <BiServer className="inline-block align-text-bottom mb-0.5" />{" "}
              environments to improve my versatility as a programmer.{" "}
              <BiCode className="inline-block align-text-bottom mb-0.5" />
            </p>
          </div>
          <div className="py-8 col-span-1 flex justify-center items-center gap-8 flex-row md:flex-col border-2 rounded-xl md:rounded-none md:rounded-br-2xl  border-purple-950 text-gray-400 bg-gradient-to-b from-transparent from-60% via-zinc-950 to-zinc-900 shadow-md shadow-purple-950">
            <a
              href=""
        ...
        <div className="flex flex-col justify-center border border-purple-950 h-56 rounded-2xl bg-gradient-to-b from-transparent from-50% via-purple-950 to-purple-900 shadow-md shadow-purple-950">
          <p className="text-gray-100 text-4xl tracking-tighter text-center px-3 font-medium">
            ...
            stack at a time{" "}
            <BiCoinStack className="inline-block align-text-bottom mb-0.5" />{" "}
            <span className="text-purple-500">{"/>"}</span>
          </p>
        </div>
        <div className="flex flex-col justify-center mt-1 items-center">
          <div className="border-dashed border-purple-600 border-2 h-16">
          </div>
          <div className="bg-purple-600 h-4 w-4 mt-1 rounded-full shadow-lg shadow-purple-500"></div>
        </div>
      </section>
    </>
  );
