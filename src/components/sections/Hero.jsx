...
export const Hero = () => {
  return (
    <section className="grid border border-zinc-900 grid-rows-2 h-[98vh]">
      <div className="row-span-1 mt-4 flex border border-zinc-900 bg-gradient-to-b from-transparent from-60% via-black to-emerald-950 justify-center items-center flex-col">
      ...
      <div className="grid auto-rows-min grid-cols-1 gap-4 mt-4 border border-zinc-900">
        <div className="col-span-1 text-gray-400 mx-4 font-medium tracking-tight mt-4 text-sm">
          <p>
            Specializing in building awesome, expert and exceptional apps web.
            Currently, I am focused on exploring different back end environments
            to improve my versatility as a programmer.
          </p>
        </div>
